...
include("classes/posts.class.php");
  ...
  if(isset($_GET['search'])){
   ...
   $postsObj->fetchSearchResult($searchQuery);
   
   echo "<p class=\"search-title\"> We found ". $postsObj->numSearchResult ." posts about " . $searchQuery ."!</p>";
   foreach($postsObj->getSearchResult() as $post){
